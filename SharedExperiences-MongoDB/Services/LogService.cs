    ...
    public class LogService
    {
        ...
        public async Task<DiagnosticInfo> GetDiagnosticInfoAsync()
        {
            ...
            try
            {
                ...
                {
                    var sampleLog = await _logs.Find(Builders<LogEntry>.Filter.Empty)
                ...
                // Try raw document approach to see full structure
                var rawDoc = await _logs.Database.GetCollection<BsonDocument>(_collectionName)
